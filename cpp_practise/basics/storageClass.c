...
// int fun()
// {
//     static int x = 0; // static will be declared once only!
//     x++;
//     return x;
// }
...
// classes 
/*
    if we want to find how many times function is called in program
    then we will use static variable
*/

/*
    Static variables have a property of preserving their value even after 
    they are out of their scope! Hence, static variables preserve their 
    previous value in their previous scope and are not initialized 
